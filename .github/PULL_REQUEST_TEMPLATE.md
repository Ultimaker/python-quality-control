Jira ticket: [EMB-463](https://ultimaker.atlassian.net/browse/EMB-463)
...
- [ ] Pre-commit static checks pass cleanly on this branch's diff (`scripts/verify_and_create_pr.sh`)

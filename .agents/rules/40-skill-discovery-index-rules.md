...
- **cmake** — Modern target-centric C/C++ engineering with CMake 3 & 4.
...
- **conan-2** — Engineering guide for Conan 2 dependency management, cross-compilation, CMake integrations, and packaging workflows.
- **cpp-pro** — Expert modern C++ (C++11 through C++23) engineering grounded in the ISO C++ Core Guidelines.
...
- **ultimaker-retrospective-engineering** — Conduct retrospective post-mortems for AI agent/developer incidents and translate takeaways into automated tool hooks and CI guardrails.
